 ...
 * @internal
 * @group functional
 * @covers \Ajardin\BlizzardSdkBundle\BlizzardApi\WorldOfWarcraft\CharacterProfessionsApi
 */
final class CharacterProfessionsApiTest extends ApiTestCase
{
    public function testItRetrievesSummary(): void
    {
        $client = new CharacterProfessionsApi($this->createBlizzardHttpClient());
